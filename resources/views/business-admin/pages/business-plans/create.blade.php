            ...
            <div class="container-xl">
                ...
                <div class="row row-deck row-cards">
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <form action="{{ route('business-admin.business-plans.store', ['business_id' => $business_id]) }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="plan_price"
                                                        ...
                                                        value="{{ old('plan_price') }}" step="0.01" min="0" required />
                                                </div>
                                            </div>
                                                        ...
                                                        @foreach($businessServices as $service)
                                                            <label class="form-check">
                                                                <input type="checkbox" 
                                                                    ...
                                                                    {{ in_array($service->business_service_id, old('business_service_ids', [])) ? 'checked' : '' }}>
                                            ...
                                            <div class="col-md-6 col-xl-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="duration_months" required style="border: 1px solid #d1d5db !important; border-right: 1px solid #d1d5db !important;">
                                                        <option value="">{{ __('Select duration') }}</option>
                                                        @foreach($durationOptions as $option)
                                                            <option value="{{ $option['value'] }}" 
                                                                {{ old('duration_months') == $option['value'] ? 'selected' : '' }}>
                                                                {{ $option['label'] }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="plan_description" rows="3"
                                                        placeholder="{{ __('Enter plan description') }}">{{ old('plan_description') }}</textarea>
                                                </div>
                                            </div>
